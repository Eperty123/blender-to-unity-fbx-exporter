...
def export_unity_fbx(context, filepath, embed_textures, active_collection, selected_objects, deform_bones, leaf_bones):
    global shared_data
    global hidden_collections
    global hidden_objects
    global disabled_collections
...
class ExportUnityFbx(Operator, ExportHelper):
    ...
    def execute(self, context):
        return export_unity_fbx(context, self.filepath, self.embed_textures, self.active_collection, self.selected_objects, self.deform_bones, self.leaf_bones)
